...
# Getting the original data from the document to a list
    ...
    display_cards_rows = product_amount - 1

    return render_template("products.html", display_cards_rows=int(display_cards_rows), product_dict=product_dict,  product_amount=product_amount, page=final_img_src_list, pagetest=decode_grabbed_url_html, review_text_string=review_text_string)
